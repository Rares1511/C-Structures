...
test_res test_deque_init() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_INIT", .reason = "deque_init failed", .return_code = res};
    }
    if (dq.size != 0 || dq.front != NULL || dq.back != NULL || dq.attr.size != sizeof(int) ||
        dq.attr.copy != NULL) {
        return (test_res){.test_name = "TEST_DEQUE_INIT",
                          .reason = "deque_init failed",
                          .return_code = CS_UNKNOWN};
    }
    return (test_res){
        .test_name = "TEST_DEQUE_INIT", .reason = "deque_init success", .return_code = CS_SUCCESS};
}
...
test_res test_deque_init_wrong_attr() {
    ...
    if (res != CS_SIZE) {
        return (test_res){.test_name = "TEST_DEQUE_INIT_WRONG_ATTR",
                          .reason = "deque_init was not failed though a negative size was given",
                          .return_code = res};
    }
    ...
    if (res != CS_SIZE) {
        return (test_res){
            .test_name = "TEST_DEQUE_INIT_WRONG_ATTR",
            .reason = "deque_init was not failed though a size bigger than the threshold was given",
            .return_code = res};
    }
    return (test_res){.test_name = "TEST_DEQUE_INIT_WRONG_ATTR",
                      .reason = "deque_init failed correctly",
...
test_res test_deque_push_back() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_PUSH_BACK", .reason = "deque_init failed", .return_code = res};
    }
    for (int i = 0; i < (int)(sizeof(deque_values) / sizeof(int)); i++) {
        res = deque_push_back(&dq, &deque_values[i]);
        if (res != CS_SUCCESS) {
            return (test_res){.test_name = "TEST_DEQUE_PUSH_BACK",
                              .reason = "deque_push_back failed",
                              .return_code = res};
        }
    }
    ...
    if (dq.front != NULL || dq.back != NULL || dq.size != 0) {
        return (test_res){.test_name = "TEST_DEQUE_PUSH_BACK",
                          .reason = "deque_free failed",
                          .return_code = CS_UNKNOWN};
    }
    return (test_res){.test_name = "TEST_DEQUE_PUSH_BACK",
                      .reason = "deque_push_back success",
                      .return_code = CS_SUCCESS};
}
...
test_res test_deque_push_front() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){.test_name = "TEST_DEQUE_PUSH_FRONT",
                          .reason = "deque_init failed",
                          .return_code = res};
    }
    for (int i = 0; i < (int)(sizeof(deque_values) / sizeof(int)); i++) {
        ...
        if (res != CS_SUCCESS) {
            return (test_res){.test_name = "TEST_DEQUE_PUSH_FRONT",
                              .reason = "deque_push_front failed",
                              .return_code = res};
        }
    }
    ...
    return (test_res){.test_name = "TEST_DEQUE_PUSH_FRONT",
                      .reason = "deque_push_front success",
                      .return_code = CS_SUCCESS};
}
...
test_res test_deque_pop_back() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_POP_BACK", .reason = "deque_init failed", .return_code = res};
    }
    for (int i = 0; i < (int)(sizeof(deque_values) / sizeof(int)); i++) {
        res = deque_push_back(&dq, &deque_values[i]);
        if (res != CS_SUCCESS) {
            return (test_res){.test_name = "TEST_DEQUE_POP_BACK",
                              .reason = "deque_push_back failed",
                              .return_code = res};
        }
    }
    ...
    if (check_values(dq, deque_values_delete, (int)(sizeof(deque_values_delete) / sizeof(int))) ==
        false) {
        return (test_res){.test_name = "TEST_DEQUE_POP_BACK",
                          .reason = "values were not popped back correctly",
                          .return_code = CS_UNKNOWN};
    }
...
test_res test_deque_pop_front() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_POP_FRONT", .reason = "deque_init failed", .return_code = res};
    }
    for (int i = 0; i < (int)(sizeof(deque_values) / sizeof(int)); i++) {
        res = deque_push_back(&dq, &deque_values[i]);
        if (res != CS_SUCCESS) {
            return (test_res){.test_name = "TEST_DEQUE_POP_FRONT",
                              .reason = "deque_push_back failed",
                              .return_code = res};
        }
    }
    ...
    if (check_values(dq, deque_values_delete, (int)(sizeof(deque_values_delete) / sizeof(int))) ==
        false) {
        return (test_res){.test_name = "TEST_DEQUE_POP_FRONT",
                          .reason = "values were not popped front correctly",
                          .return_code = CS_UNKNOWN};
    }
    ...
    return (test_res){.test_name = "TEST_DEQUE_POP_FRONT",
                      .reason = "deque_pop_front success",
                      .return_code = CS_SUCCESS};
}
...
test_res test_deque_front() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_FRONT", .reason = "deque_init failed", .return_code = res};
    }
    for (int i = 0; i < (int)(sizeof(deque_values) / sizeof(int)); i++) {
        res = deque_push_back(&dq, &deque_values[i]);
        if (res != CS_SUCCESS) {
...
test_res test_deque_back() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_BACK", .reason = "deque_init failed", .return_code = res};
    }
    for (int i = 0; i < (int)(sizeof(deque_values) / sizeof(int)); i++) {
        res = deque_push_back(&dq, &deque_values[i]);
        if (res != CS_SUCCESS) {
    ...
    return (test_res){
        .test_name = "TEST_DEQUE_BACK", .reason = "deque_back success", .return_code = CS_SUCCESS};
}
...
test_res test_deque_swap() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_SWAP", .reason = "deque_init failed", .return_code = res};
    }
    ...
    for (int i = 0; i < (int)(sizeof(deque_values1) / sizeof(int)); i++) {
        ...
        if (res != CS_SUCCESS) {
            return (test_res){.test_name = "TEST_DEQUE_SWAP",
                              .reason = "deque_push_back failed",
                              .return_code = res};
        }
    }
    ...
    // Swap dq1 and dq2
    deque_swap(&dq1, &dq2);
    if (dq1.size != (int)(sizeof(deque_values2) / sizeof(int)) ||
        dq2.size != (int)(sizeof(deque_values1) / sizeof(int))) {
        return (test_res){.test_name = "TEST_DEQUE_SWAP",
                          .reason = "deque_swap failed",
                          .return_code = CS_UNKNOWN};
    }
    if (check_values(dq1, deque_values2, (int)(sizeof(deque_values2) / sizeof(int))) == false) {
        return (test_res){.test_name = "TEST_DEQUE_SWAP",
                          .reason = "values were not swapped correctly",
                          .return_code = CS_UNKNOWN};
    }
    ...
    if (dq1.front != NULL || dq1.back != NULL || dq1.size != 0) {
        return (test_res){.test_name = "TEST_DEQUE_SWAP",
                          .reason = "deque_free for 1st deque failed",
                          .return_code = CS_UNKNOWN};
    }
    ...
    if (dq1.front != NULL || dq1.back != NULL || dq1.size != 0) {
        return (test_res){.test_name = "TEST_DEQUE_SWAP",
                          .reason = "deque_free for 2nd deque failed",
                          .return_code = CS_UNKNOWN};
    }
    return (test_res){
        .test_name = "TEST_DEQUE_SWAP", .reason = "deque_swap success", .return_code = CS_SUCCESS};
}
...
test_res test_deque_copy() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_COPY", .reason = "deque_init failed", .return_code = res};
    }

    // Push a struct to dq
    struct painting p = {
        "Mona Lisa", 1503, 3, (int[]){1, 2, 3}
    };
    res = deque_push_back(&dq, &p);
    if (res != CS_SUCCESS || dq.size != 1 || dq.front == NULL || dq.back == NULL) {
        return (test_res){
            .test_name = "TEST_DEQUE_COPY", .reason = "deque_push_back failed", .return_code = res};
    }
    ...
    return (test_res){
        .test_name = "TEST_DEQUE_COPY", .reason = "deque_copy success", .return_code = CS_SUCCESS};
}
...
test_res test_deque_set_attr() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_SET_ATTR", .reason = "deque_init failed", .return_code = res};
    }

    // Set new attributes for dq
    deque_set_attr(&dq, new_attr);
    if (dq.attr.size != new_attr.size || dq.attr.fr != new_attr.fr ||
        dq.attr.copy != new_attr.copy || dq.attr.print != new_attr.print) {
        return (test_res){.test_name = "TEST_DEQUE_SET_ATTR",
                          .reason = "deque_set_attr failed",
                          .return_code = CS_UNKNOWN};
    }
...
test_res test_deque_set_attr_wrong() {
    ...
    cs_codes res = deque_init(&dq, attr);
    if (res != CS_SUCCESS) {
        return (test_res){.test_name = "TEST_DEQUE_SET_ATTR_WRONG",
                          .reason = "deque_init failed",
                          .return_code = res};
    }
...
test_res test_deque_set_free() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_SET_FREE", .reason = "deque_init failed", .return_code = res};
    }
    ...
    res = deque_push_back(&dq, &p);
    if (res != CS_SUCCESS || dq.size != 1 || dq.front == NULL || dq.back == NULL) {
        return (test_res){.test_name = "TEST_DEQUE_SET_FREE",
                          .reason = "deque_push_back failed",
                          .return_code = res};
    }
...
test_res test_deque_set_print() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_SET_PRINT", .reason = "deque_init failed", .return_code = res};
    }
    ...
    res = deque_push_back(&dq, &p);
    if (res != CS_SUCCESS || dq.size != 1 || dq.front == NULL || dq.back == NULL) {
        return (test_res){.test_name = "TEST_DEQUE_SET_PRINT",
                          .reason = "deque_push_back failed",
                          .return_code = res};
    }
    ...
    return (test_res){.test_name = "TEST_DEQUE_SET_PRINT",
                      .reason = "deque_set_print success",
                      .return_code = CS_SUCCESS};
}
...
test_res test_deque_set_copy() {
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_SET_COPY", .reason = "deque_init failed", .return_code = res};
    }

    // Set new copy function for dq
    deque_set_copy(&dq, new_copy);
    if (dq.attr.copy != new_copy) {
        return (test_res){.test_name = "TEST_DEQUE_SET_COPY",
                          .reason = "deque_set_copy failed",
                          .return_code = CS_UNKNOWN};
    }
...
test_res test_deque_set_copy_wrong() {
    ...
    cs_codes res = deque_init(&dq, attr);
    if (res != CS_SUCCESS) {
        return (test_res){.test_name = "TEST_DEQUE_SET_COPY_WRONG",
                          .reason = "deque_init failed",
                          .return_code = res};
    }
...
test_res test_deque_clone() {
    deque dq, dq_clone;
    deque_attr_t attr = {sizeof(struct painting), free_painting, copy_painting, print_painting};
    struct painting paintings[] = {
        {"Mona Lisa",                 1503, 3, (int[]){1, 2, 3}   },
        {"The Starry Night",          1889, 3, (int[]){4, 5, 6}   },
        {"The Persistence of Memory", 1931, 3, (int[]){7, 8, 9}   },
        {"The Scream",                1893, 3, (int[]){10, 11, 12}},
        {"The Last Supper",           1498, 3, (int[]){13, 14, 15}},
    };
    ...
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_CLONE", .reason = "deque_init failed", .return_code = res};
    }

    for (int i = 0; i < (int)(sizeof(paintings) / sizeof(struct painting)); i++) {
        res = deque_push_back(&dq, &paintings[i]);
        if (res != CS_SUCCESS) {
    ...
    // Clone dq
    res = deque_clone(&dq_clone, dq);
    if (res != CS_SUCCESS) {
        return (test_res){
            .test_name = "TEST_DEQUE_CLONE", .reason = "deque_clone failed", .return_code = res};
    }
    if (dq_clone.size != dq.size || dq_clone.front == dq.front || dq_clone.back == dq.back) {
        return (test_res){.test_name = "TEST_DEQUE_CLONE",
                          .reason = "deque_clone failed",
                          .return_code = CS_UNKNOWN};
    }
    ...
    while (dq.size > 0) {
        ...
        if (res != CS_SUCCESS) {
            return (test_res){.test_name = "TEST_DEQUE_CLONE",
                              .reason = "deque_pop_front on source deque failed",
                              .return_code = res};
        }
        res = deque_pop_front(&dq_clone);
        if (res != CS_SUCCESS) {
            return (test_res){.test_name = "TEST_DEQUE_CLONE",
                              .reason = "deque_pop_front on cloned deque failed",
                              .return_code = res};
        }
    }
    ...
    if (dq.front != NULL || dq.back != NULL || dq.size != 0) {
        return (test_res){.test_name = "TEST_DEQUE_CLONE",
                          .reason = "deque_free failed on source deque",
                          .return_code = CS_UNKNOWN};
    }

    // Free memory of dq_clone
    deque_free(&dq_clone);
    if (dq_clone.front != NULL || dq_clone.back != NULL || dq_clone.size != 0) {
        return (test_res){.test_name = "TEST_DEQUE_CLONE",
                          .reason = "deque_free failed on cloned deque",
                          .return_code = CS_UNKNOWN};
    }

    return (test_res){.test_name = "TEST_DEQUE_CLONE",
                      .reason = "deque_clone success",
                      .return_code = CS_SUCCESS};
}
...
int main() {
    int i;
    test tests[] = {
        test_deque_init,      test_deque_init_wrong_attr,
        test_deque_push_back, test_deque_push_front,
        test_deque_pop_back,  test_deque_pop_front,
        test_deque_front,     test_deque_back,
        test_deque_swap,      test_deque_copy,
        test_deque_set_attr,  test_deque_set_attr_wrong,
        test_deque_set_free,  test_deque_set_print,
        test_deque_set_copy,  test_deque_set_copy_wrong,
        test_deque_clone,
    };
    test_res res;
