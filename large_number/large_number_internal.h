...
/*!
 * Adds two large numbers structures and saves the result in the first number and returns the code
 * for the operation
 ...
 * @return CS_SUCCESS for a successful addition or CS_MEM if a memory problem occured during
 * reallocation of memory
 */
cs_codes large_number_add_helper(large_number *ln1, large_number ln2);

/*!
 * Subtracts the second large number from the first and saves the result in the first number and
 * returns the code for the operation
...
/*!
 * Multiplies two large numbers structures and saves the result in the first number and returns the
 ...
 * @return CS_SUCCESS for a successful multiplication or CS_MEM if a memory problem occured during
 * reallocation of memory
 */
cs_codes large_number_mul_helper(large_number *ln1, large_number ln2);

/*!
 * Divides the first number by the second with an accuracy number of digits calculated if a rest
 * large number is not given
 ...
 * @param[in] accuracy   The number of digits to be calculated in the division if a large numbers
 * for rest is not given
 * @return CS_SUCCESS for a successful divison or CS_MEM if a memory problem occured during
 * reallocation of memory
 */
cs_codes large_number_div_helper(large_number *ln1, large_number *rest, large_number ln2,
                                 int accuracy);
