...
/*!
 * Sets the new attributes for the elements of the hash table
 * @param[out] ht  Hash table whose attributes will be changed
 * @param[in]  fr  New attributes for the hash table
 */
void hash_tanle_set_attr(hash_table *ht, hash_table_attr_t attr);
...
/*!
 * Sets the new copy functionf for the hash table elements
 * @param[out] ht  Hash table whose copy function will be changed
 * @param[in]  cp  New copy function for copying elements inside the hash table
 */
void hash_table_set_copy(hash_table *ht, deepcopy cp);
