...
/*!
 * Selects the attributes for the values inside the pair fst value
 * @param[in] p        The pair whose first element attributes will be replaced
 * @param[in] fst_attr The new attributes for the first element
 */
void pair_set_fst_attr(pair *p, pair_attr_t fst_attr);

/*!
 * Selects the attributes for the values inside the pair snd value
 * @param[in] p        The pair whose second element attributes will be replaced
 * @param[in] snd_attr The new attributes for the second element
 */
void pair_set_snd_attr(pair *p, pair_attr_t snd_attr);

/*!
 * Selects the attributes for values inside the pair
 * @param[in] p        The pair whose elements attributes will be replaced
 * @param[in] fst_attr The new attributes for the first element
 * @param[in] snd_attr The new attributes for the second element
 */
void pair_set_both_attr(pair *p, pair_attr_t fst_attr, pair_attr_t snd_attr);
...
/*!
 * Selects the copy function for the first element of the pair
 * @param[in] p        The pair whose first element copy function will be replaced
 * @param[in] fst_copy The new copy function for the first element
 */
void pair_set_fst_copy(pair *p, deepcopy fst_cp);

/*!
 * Selects the copy function for the second element of the pair
 * @param[in] p        The pair whose second element copy function will be replaced
 * @param[in] snd_copy The new copy function for the second element
 */
void pair_set_snd_copy(pair *p, deepcopy snd_cp);

/*!
 * Selects the copy function for the elements of the pair
 * @param[in] p        The pair whose elements copy function will be replaced
 * @param[in] fst_copy The new copy function for the first element
 * @param[in] snd_copy The new copy function for the second element
 */
...
/*!
 * Sets the compare function for the first element of the pair
 * @param[in] p        Pair whose first element compare function will be changed
 * @param[in] fst_comp New compare function for the first element
 */
void pair_set_fst_comp(pair *p, comparer fst_comp);

/*!
 * Sets the compare function for the second element of the pair
 * @param[in] p        Pair whose second element compare function will be changed
 * @param[in] snd_comp New compare function for the second element
 */
void pair_set_snd_comp(pair *p, comparer snd_comp);

/*!
 * Sets the compare function for the elements of the pair
 * @param[in] p        Pair whose elements compare function will be changed
 * @param[in] fst_comp New compare function for the first element
 * @param[in] snd_comp New compare function for the second element
 */
void pair_set_both_comp(pair *p, comparer fst_comp, comparer snd_comp);
