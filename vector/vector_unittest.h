...
test_res test_vector_init(test_arg *arg) {
    ...
    vector *vec = vector_init(attr, (vector_attr_t){0, 0});
...
test_res test_vector_push_back_single(test_arg *arg) {
    vector *vec = vector_init(get_test_struct_attr(), (vector_attr_t){0, 0});
    if (vec == NULL) {
...
test_res test_vector_swap(test_arg *arg) {
    vector *vec1 = vector_init(get_test_struct_attr(), (vector_attr_t){0, 0});
    vector *vec2 = vector_init(get_test_struct_attr(), (vector_attr_t){0, 0});
...
test_res test_vector_sort_by_score(test_arg *arg) {
    vector *vec = vector_init(get_test_struct_attr_by_score(), (vector_attr_t){0, 0});
    if (vec == NULL) {
        return (test_res){(char*)__func__, "Vector initialization failed", CS_MEM};
    }
...
test_res test_vector_stress_time(test_arg *arg) {
    ...
    vector *v = vector_init(get_int_attr(), (vector_attr_t){0, 1});
