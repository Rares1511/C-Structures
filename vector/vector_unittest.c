...
test_res test_vector_push_back_single() {
    vector *vec = vector_init(get_test_struct_attr());
...
test_res test_vector_swap() {
    vector *vec1 = vector_init(get_test_struct_attr());
    vector *vec2 = vector_init(get_test_struct_attr());
...
test_res test_vector_sort_by_score() {
    vector *vec = vector_init(get_test_struct_attr_by_score());
